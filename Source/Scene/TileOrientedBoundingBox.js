...
define([
    ...
    /**
     * @param {Cartesian3} [options.center=Cartesian3.ZERO] The center of the box.
     * @param {Matrix3} [options.halfAxes=Matrix3.ZERO] The three orthogonal half-axes of the bounding box.
